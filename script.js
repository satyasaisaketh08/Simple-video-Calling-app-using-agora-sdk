...
//#2
let config = {
    appid: '681abe43c1364d2eb78f3bb593c2eddd',
    token: '006681abe43c1364d2eb78f3bb593c2edddIADkqMaE5Vqb77y1AOfiOtwgKpFPMcaSqOxxuS3meBI39+niQ5sAAAAAEAAD1/lOr6gjYgEAAQCvqCNi+niQ5sAAAAAEAAD1/lOr6gjYgEAAQCvqCNi',
    uid:null,
    channel:'agoratask',
}
...
document.getElementById('camera-btn').addEventListener('click', async () => {
    ...
    if(!localTrackState.videoTrackMuted){
        ...
        document.getElementById('camera-btn').style.backgroundColor ='rgb(255,0,0)'
    }else{
